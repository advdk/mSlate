"use strict";
(self["webpackChunkslate"] = self["webpackChunkslate"] || []).push([["vendors-node_modules_codemirror_language_dist_index_js-node_modules_lezer_lr_dist_index_js"],{
...
const bracketMatcher = /*@__PURE__*/_codemirror_view__WEBPACK_IMPORTED_MODULE_2__.ViewPlugin.fromClass(class {
    constructor(view) {
        this.paused = false;
...
*/
class BlockWrapper extends _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.RangeValue {
...
const blockWrappers = /*@__PURE__*/_codemirror_state__WEBPACK_IMPORTED_MODULE_0__.Facet.define();
...
class WidgetBufferTile extends Tile {
    ...
    get overrideDOMText() { return _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.Text.empty; }
...
class TileUpdate {
    constructor(view, old, blockWrappers, decorations, disallowBlockEffectsFor) {
        ...
        this.builder = new TileBuilder(this.cache, new DocTile(view, view.contentDOM), _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.RangeSet.iter(blockWrappers));
    ...
    emit(from, to) {
        ...
        let openEnd = _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.RangeSet.spans(this.decorations, from, to, {
    ...
    coordsForChar(pos) {
        ...
        function scan(tile, offset) {
            if (tile.isComposite()) {
                ...
                let end = (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_0__.findClusterBreak)(tile.text, offset);
                if (end == offset)
                    return null;
...
function moveVertically(view, start, forward, distance) {
    ...
    for (let scan = 0;; scan += halfText) {
        ...
        if (forward ? y > rect.bottom : y < rect.top)
            return _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.cursor(pos.pos, pos.assoc);
        ...
        if (!posCoords || (forward ? mid > startY : mid < startY))
            return _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.cursor(pos.pos, pos.assoc, undefined, goal);
    }
}
...
class InlineCoordsScan {
    ...
    scanText(tile, offset) {
        let positions = [];
        for (let i = 0; i < tile.length; i = (0,_codemirror_state__WEBPACK_IMPORTED_MODULE_0__.findClusterBreak)(tile.text, i))
...
class DOMReader {
    constructor(points, view) {
        ...
        this.view = view;
        this.text = "";
        this.lineSeparator = view.state.facet(_codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorState.lineSeparator);
    }
    append(text) {
        this.text += text;
    }
    ...
    constructor(view, start, end, typeOver) {
        ...
        if (view.state.readOnly && start > -1) {
            ...
            if (view.inputState.composing > -1 && curSel.ranges.length > 1) {
                this.newSel = curSel.replaceRange(_codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.range(anchor, head));
            }
                ...
                this.newSel = _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.create([_codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.cursor(head, assoc)]);
            }
            else {
    ...
    if (domChange.bounds) {
        ...
        if (!sel.empty && sel.from >= from && sel.to <= to && (domChange.typeOver || cmp != domChange.text) &&
            ...
            change = { from: sel.from, to: sel.to,
                insert: _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.Text.of(domChange.text.slice(sel.from - from, selEnd).split(LineBreakPlaceholder)) };
        }
    ...
    return {
        ...
        get(event, extend, multiple) {
            ...
            if (start.pos != cur.pos && !extend) {
                ...
                range = from < range.from ? _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.range(from, to, range.assoc) : _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.range(to, from, range.assoc);
            }
            if (extend)
...
function staticDeco(state) {
    ...
    if (outer.length)
        deco.push(_codemirror_state__WEBPACK_IMPORTED_MODULE_0__.RangeSet.join(outer));
    return deco;
}
    ...
    constructor(view) {
        ...
        this.handlers.textupdate = e => {
            ...
            let change = { from: diff.from + from, to: diff.toA + from,
                insert: _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.Text.of(e.text.slice(diff.from, diff.toB).split("\n")) };
    ...
    */
    constructor(config = {}) {
        ...
        */
        ...
        this.viewState = new ViewState(this, config.state || _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorState.create(config));
    ...
    markers(view) {
        ...
        for (let r of state.selection.ranges) {
            ...
            if (r.empty || conf.drawRangeCursor && !(prim && browser.ios && conf.iosSelectionHandles)) {
                ...
                let cursor = r.empty ? r : _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.cursor(r.head, r.assoc);
...
const selectionLayer = /*@__PURE__*/layer({
    ...
    markers(view) {
        ...
        if (browser.ios && !main.empty && view.state.facet(selectionConfig).iosSelectionHandles) {
            for (let piece of RectangleMarker.forRange(view, "cm-selectionHandle cm-selectionHandle-start", _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.cursor(main.from, 1)))
                markers.push(piece);
            for (let piece of RectangleMarker.forRange(view, "cm-selectionHandle cm-selectionHandle-end", _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.cursor(main.to, 1)))
                markers.push(piece);
        }
        return markers;
    },
...
//# sourceMappingURL=vendors-node_modules_codemirror_language_dist_index_js-node_modules_lezer_lr_dist_index_js.renderer.js.map